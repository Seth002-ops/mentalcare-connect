...
const Booking = () => {
  ...
  useEffect(() => {
    ...
    const fetchTherapists = async () => {
      try {
        const response = await fetch('https://mecac-backend.onrender.com_URL || '') + '/users?user_type=therapist', {
          headers: {
  ...
  const handleBook = async () => {
    ...
    try {
      const response = await fetch('https://mecac-backend.onrender.com_URL || '') + '/bookings', {
        method: 'POST',
        headers: {
          Authorization: `Bearer ${token}`,
